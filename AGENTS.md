...
Hodor uses [`@earendil-works/pi-coding-agent`](https://github.com/earendil-works/pi) for the agent runtime:
...
- **Model Resolution**: `getModel()` from `@earendil-works/pi-ai/compat` for known providers; custom model objects for Bedrock ARNs
